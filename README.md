...
The Vite base path is configured for a repository named `rashmi-portfolio`.

1. Create a public GitHub repository named `rashmi-portfolio`.
...
5. Open **Actions** to check the deployment. The site URL will be:
	`https://YOUR_USERNAME.github.io/rashmi-portfolio/`
